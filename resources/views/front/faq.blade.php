...
<!-- Mirrored from demo.hasthemes.com/melani-v3/melani/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jun 2020 07:15:57 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <ul>
                                        ...
                                        <li class="static"><a href="#">pages <i class="fa fa-angle-down"></i></a>
                                            <ul class="megamenu dropdown">
                                                ...
                                                <li class="megamenu-banners d-none d-lg-block"><a href="#"><img src="assets/img/banner/banner-6.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <div class="faq-inner mt-md-96 mt-sm-56">
                            ...
                            <div class="accordion" id="payment">
                                <div class="card">
                                    <div class="card-header" id="headingSix">
                                        <h5 class="mb-0">
                                            <button class="accordio-heading" type="button" data-toggle="collapse"       data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
                                                <i class="ion-ribbon-b"></i>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingSeven">
                                        <h5 class="mb-0">
                                            <button class="accordio-heading" type="button" data-toggle="collapse"       data-target="#collapseSeven" aria-controls="collapseSeven">
                                                <i class="ion-android-car"></i>
                                                Fast Free Delivery
                                            </button>
                                        </h5>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingEight">
                                        <h5 class="mb-0">
                                            <button class="accordio-heading" type="button" data-toggle="collapse"       data-target="#collapseEight" aria-controls="collapseEight">
                                                <i class="ion-university"></i>
                                                Rich Experience
                                            </button>
                                        </h5>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingNine">
                                        <h5 class="mb-0">
                                            <button class="accordio-heading" type="button" data-toggle="collapse"       data-target="#collapseNine" aria-controls="collapseNine">
                                                <i class="ion-android-car"></i>
                                                Fast Free Delivery
                                            </button>
                                        </h5>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTen">
                                        <h5 class="mb-0">
                                            <button class="accordio-heading" type="button" data-toggle="collapse"       data-target="#collapseTen" aria-controls="collapseTen">
                                                <i class="ion-university"></i>
                                                Rich Experience
                                            </button>
                                        </h5>
