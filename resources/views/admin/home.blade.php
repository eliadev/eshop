						   ...
						   <div class="row">
							  ...
							  <div class="col-6">
								 <div class="text-right">
									<h3 class="text-dark mt-1">$<span data-plugin="counterup">{!! $ordersSum !!}</span></h3>
					 ...
					 <div class="col-md-6 col-xl-3">
						<div class="widget-rounded-circle card-box">
						   <div class="row">
							  ...
							  <div class="col-6">
								 <div class="text-right">
									<h3 class="text-dark mt-1"><span data-plugin="counterup">{!! $ordersCount !!}</span></h3>
						   ...
						   <div class="row">
							  <div class="col-6">
								 <div class="avatar-lg rounded bg-soft-info">
									<i class="dripicons-cart font-24 avatar-title text-info"></i>
								 </div>
							  </div>
							  <div class="col-6">
								 <div class="text-right">
									<h3 class="text-dark mt-1"><span data-plugin="counterup">{!! $orderItemsSum !!}</span></h3>
