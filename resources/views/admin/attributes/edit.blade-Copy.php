	...
	<div class="content">
		<div class="container-fluid">
				...
				<div class="col-md-8">
					<div class="card-box">
						...
						<form action="#" method="POST" enctype="multipart/form-data">
							...
							<div class="col-md-2">
								<button type="submit" class="btn btn-success btn-rounded w-md waves-effect waves-light mb-5" style="width:100%;">SAVE</button>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="card-box">
						<h5 class="text-uppercase mt-0 mb-3 bg-light p-2">Option Values</h5>
